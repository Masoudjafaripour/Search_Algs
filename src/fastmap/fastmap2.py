...
# df_result = pd.DataFrame(results, index=['Nodes Expanded', 'Time (s)']).T
# import ace_tools as tools; tools.display_dataframe_to_user(name="A* Heuristic Comparison (Large Octile Map)", dataframe=df_result)
